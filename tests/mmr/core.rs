...
mod tests {
    ...
    use accumulators::{
        ...
        mmr::{
            map_leaf_index_to_element_index, AppendResult, PeaksOptions, Proof, ProofOptions, MMR,
        },
    ...
    async fn append_block_range_keccak_aggregator() {
        ...
        let mut mmr =
            MMR::create_with_genesis(store.clone(), hasher.clone(), Some("mmr".to_string()))
                .await
                .unwrap();

        // block 9734438
        mmr.append(
            "0xcd5631a363d4c9bfc86d3504102595c39d7cd90a940fd165e1bdd911aa504d0a".to_string(),
        )
        .await
        ...
        // block 9734439
        mmr.append(
            "0x62154309a502f33764c4ec3267e2cabf561dc9e428b0607f6f458942bbe0e02d".to_string(),
        )
        .await
        .expect("Failed to append");
        ...
        // block 9734440
        mmr.append(
            "0x5104aee2cb3cc519cca3580144624c197a0e8b80ef080fe29698221f9963207d".to_string(),
        )
        .await
        .expect("Failed to append");
        assert_eq!(
        ...
        // block 9734441
        mmr.append(
            "0x09ab9ad1513282a5c1e1b4c15436aee479e9759712ebe6e5dbb02411537633e1".to_string(),
        )
        .await
        .expect("Failed to append");
        assert_eq!(
        ...
        // block 9734442
        mmr.append(
            "0x5cb8bb916e22e6ab4c0fca4bebc13b05dcaaa7eccacd7636b755d944de4e9217".to_string(),
        )
        .await
        .expect("Failed to append");
        assert_eq!(
        ...
        // block 9734443
        mmr.append(
            "0x0b756461f355b8fb1a6dfdfe5d943f7c037c62b99e806a579500a8a73821e250".to_string(),
        )
        .await
        .expect("Failed to append");
        assert_eq!(
        ...
        // block 9734444
        mmr.append(
            "0x3965b0ccf016b56564129ab0f96400c3a84a8e6fa5d25327a6a1762901ee00e9".to_string(),
        )
        .await
        .expect("Failed to append");
        assert_eq!(
        ...
        // block 9734445
        mmr.append(
            "0xbe9e359d2632091546be983f8b6488012d607d56c05599c9347fdfdbd86c1b3f".to_string(),
        )
        .await
        .expect("Failed to append");
        assert_eq!(
        ...
        // block 9734446
        mmr.append(
            "0xe9112c401620687b34b0fc6108f35242d32ff37914e302c423e9134851573f65".to_string(),
        )
        .await
        .expect("Failed to append");
        assert_eq!(
        ...
        // block 9734447
        mmr.append(
            "0xd6b12b6b12b253be08a02293261f71383d6159b6339d6aeab45d91643df19bd0".to_string(),
        )
        .await
        .expect("Failed to append");
        assert_eq!(
    ...
    async fn append_block_range_poseidon_aggregator() {
        ...
        // block 9734438
        mmr.append("0x07b8996d5b585da92efa32a57223dfb28fa12e6c04d36d7edb03690f03bec56".to_string())
            .await
            .expect("Failed to append");
        assert_eq!(
            mmr.leaves_count.get().await.unwrap(),
        ...
        // block 9734439
        mmr.append("0x312134454804550b4a38e1d60dc1f0be80ff62dfea8f3c6be0c257efce3b833".to_string())
            .await
            .expect("Failed to append");
        ...
        // block 9734440
        mmr.append("0x6f0b4ef760469262221de032372c2a6b47b304a48b632af80611fc2e2e10b56".to_string())
            .await
            .expect("Failed to append");
        assert_eq!(
            mmr.leaves_count.get().await.unwrap(),
        ...
        // block 9734441
        mmr.append("0x7f6d47c24e8723a6d6cf4ef089df0bd3ec710d5448b696e47b037109a1d04ce".to_string())
            .await
            .expect("Failed to append");
        assert_eq!(
            mmr.leaves_count.get().await.unwrap(),
        ...
        // block 9734442
        mmr.append("0x38e557fbc306cbcb5964a503014b375db68a0c6786fd9c6ffc5cdd14b6c9dfc".to_string())
            .await
            .expect("Failed to append");
        assert_eq!(
            mmr.leaves_count.get().await.unwrap(),
        ...
        // block 9734443
        mmr.append("0x54aa6067e8c4f6bcd7c47cf7900df1d960098177e186f0c15b6a7544491b539".to_string())
            .await
            .expect("Failed to append");
        assert_eq!(
            mmr.leaves_count.get().await.unwrap(),
        ...
        // block 9734444
        mmr.append("0x2f185aa16419cad043ddb0b75a7ba0c4233d51b7fee31f1ad6680f5c2b53677".to_string())
            .await
            .expect("Failed to append");
        assert_eq!(
            mmr.leaves_count.get().await.unwrap(),
        ...
        // block 9734445
        mmr.append("0x3ff20a1d65c24d07ebedb2de39c0a27e67808b49d1544e8ef972da1d24da302".to_string())
            .await
            .expect("Failed to append");
        assert_eq!(
            mmr.leaves_count.get().await.unwrap(),
        ...
        let elements_count = mmr.elements_count.get().await.unwrap();
        let bag = mmr.bag_the_peaks(Some(elements_count)).await.unwrap();
        mmr.calculate_root_hash(&bag, elements_count)
            .expect("Failed to calculate root hash");
        // TODO : Draft mmr have 0x27f8b7a2ed6d1290833c6fa587d564a8810ee1925b1b2cdfde8da1cefdee57b
        assert_eq!(
            root,
            "0x7abaf3802dee5c46f80d30101a3882645070d0968758b2a9b7a3bc5e1a059fa"
        );
